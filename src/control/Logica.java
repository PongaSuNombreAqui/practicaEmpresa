...
public class Logica<K> {
	 ...
	 * 
	 * @param nombre
	 *            nombre del articulo a crear
	 * @param precio
	 *            precio del articulo a crear
	 * @param id
	 *            id del articulo a crear
	 * @param descripcion
	 *            descripcion del articulo a crear
	 ...
	 * 
	 * @param combo
	 *            comboBox donde se quieren insertar los articulos
	 */
	 ...
	 * 
	 * @param dniCif
	 *            DNI o CIF del cliente a consultar
	 * @param lblDniCif
	 *            Etiqueta del DNI o CIF del cliente
	 * @param lblRazonSocial
	 *            Etiqueta del nombre del cliente
	 * @param lblDireccion
	 *            Etiqueta de la direccion del cliente
	 * @param lblTelefono
	 *            Etiqueta del telefono del cliente
	 */
	 ...
	 * 
	 * @param nombre
	 *            Nombre o DNI/CIF del cliente a buscar
	 * @param combo
	 *            Combo con los clientes que coincidan con nombre
	 */
	 ...
	 * 
	 * @param tabla
	 *            tabla donde quiere introducir el articulo
	 * @param nombre
	 ...
	 * 
	 * @param dniNif
	 *            nif del cliente del que desea el pedido
	 * @param tabla
	 *            tabla de la que coger los datos del pedido
	 * @param modelo
	 * @return
	 */
	 ...
	 * 
	 * @param tabla
	 *            tabla en la que mostrar los datos
	 * @param numeroPedido
	 *            numero del pedido a ver
	 * @param id
	 *            id del cliente de la que se queire ver el pedido
	 */
	 ...
	 * 
	 * @param combo
	 *            comboBox en el que se quieren introducir
	 */
	 ...
	 * 
	 * @param combo
	 *            comboBox en el que introducir los pedidos
	 * @param cadena
	...
	/**
	 * saca un cadena de texto separandola de la cadena entera que hay en el
	 * combobox
	 * 
	 * @param combo
	 *            del que sacar el item
